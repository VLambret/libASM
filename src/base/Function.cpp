...
void Function::comput_successor_BB(){
	...
	for(int i=0; i<_myBB.size(); i++){
		...
		if(get_BB(i).get_end()->getLine()->typeLine()==line_Instru){
			...
			//si l'instru est un BR inconditiennel 1 successeur le BB point� par le label
			...
			//si l'instru est un BR conditionnel 2 successeur le BB point� et le BB suivant
